...
class AdminListingPublishRulesController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'price_increment_by_currency' => ['sometimes', 'array'],
            'price_increment_by_currency.EUR' => ['sometimes', 'numeric', 'min:0'],
            'price_increment_by_currency.GBP' => ['sometimes', 'numeric', 'min:0'],
