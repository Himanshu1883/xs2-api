    ...
    public function profiles(): array
    {
        return [
            self::PROFILE_MINIMAL => [
                ...
                'label' => 'Minimal load',
                'description' => 'One worker per queue with longer idle sleep and strict job backpressure. Keeps inventory sync, publish, and qty sync parallel while limiting CPU.',
