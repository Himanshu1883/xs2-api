...
class IntegrationSettingService
{
    ...
    public const START_ALL_ENABLED = 'START_ALL_ENABLED';

    public const CRON_INDIVIDUAL_TOGGLES = 'CRON_INDIVIDUAL_TOGGLES';
    ...
    public const XS2_SB_FAILED_LISTING_PUBLISH_RETRY_ENABLED = 'XS2_SB_FAILED_LISTING_PUBLISH_RETRY_ENABLED';

    public const XS2_SB_FAILED_LISTING_PUBLISH_RETRY_INTERVAL_MINUTES = 'XS2_SB_FAILED_LISTING_PUBLISH_RETRY_INTERVAL_MINUTES';
