...
class Xs2SellerListingTransformer
{
    ...
    {
        $labels = [
            Xs2Ticket::FLAG_NO_AWAYTEAM_NATIONALITY => 'No away nationality',
            Xs2Ticket::FLAG_NO_AWAYTEAM_PROVINCE => 'No away province',
            Xs2Ticket::FLAG_NO_AWAY_FANS => 'No away fans',
        ];
