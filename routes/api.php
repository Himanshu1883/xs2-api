...
Route::middleware(['auth:sanctum', 'admin'])->prefix('admin')->group(function (): void {
    ...
    Route::get('sb-orders/{sbOrder}/preview-xs2-order', [SbOrderController::class, 'previewXs2Order'])->whereNumber('sbOrder');
    Route::post('sb-orders/{sbOrder}/preview-xs2-order', [SbOrderController::class, 'previewXs2Order'])->whereNumber('sbOrder');
