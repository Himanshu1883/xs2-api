...
class ListingPublishValidatorTest extends TestCase
{
    ...
    public function test_validate_payload_accepts_category_name_without_ticket_category_id(): void
    {
        $this->validator->validatePayload([
            'match_id' => 45,
            'seller_reference' => 'XS2-ref-1',
    ...
    public function test_validate_payload_ignores_legacy_ticket_category_when_category_name_present(): void
    {
        $this->validator->validatePayload([
            'match_id' => 45,
            'seller_reference' => 'XS2-ref-1',
